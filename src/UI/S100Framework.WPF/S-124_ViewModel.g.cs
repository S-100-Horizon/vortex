...
namespace S100Framework.WPF.ViewModel.S124 {
	...
	public partial class NavwarnPartViewModel : FeatureViewModel<NavwarnPart> {
		...
		public ObservableCollection<NavwarnPartViewModel.areaAffectedViewModel> areaAffecteds { get; set; } = new();
		...
		public override informationBindingDefinition[] informationBindingDefinitionsByPrimitive(Primitives primitive) => [.. InformationBindings.NavwarnPart._informationBindingDefinitions.Where(e => !e.primitives.Any() || e.primitives.Contains(primitive))];
	...
	public partial class NavwarnAreaAffectedViewModel : FeatureViewModel<NavwarnAreaAffected> {
		...
		public override informationBindingDefinition[] informationBindingDefinitionsByPrimitive(Primitives primitive) => [.. InformationBindings.NavwarnAreaAffected._informationBindingDefinitions.Where(e => !e.primitives.Any() || e.primitives.Contains(primitive))];
