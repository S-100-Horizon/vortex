...
namespace S100Framework.WPF.ViewModel.S131 {
	internal static class Bootstrap {
		public static AssociationViewModel CreateInformationAssociation(string type, string? pid = default) => type switch {
			...
			"ServiceContact" => new ServiceContactViewModel { PID = pid },
			"LocationHours" => new LocationHoursViewModel { PID = pid },
			...
			"SpatialAssociation" => new SpatialAssociationViewModel { PID = pid },
			"LimitEntrance" => new LimitEntranceViewModel { PID = pid },
			"ServiceAvailability" => new ServiceAvailabilityViewModel { PID = pid },
		...
		public static AssociationViewModel CreateFeatureAssociation(string type, string? pid = default) => type switch {
			...
			"Subsection" => new SubsectionViewModel { PID = pid },
			"Infrastructure" => new InfrastructureViewModel { PID = pid },
			"PrimaryAuxiliaryFacility" => new PrimaryAuxiliaryFacilityViewModel { PID = pid },
			"Demarcation" => new DemarcationViewModel { PID = pid },
			"JurisdictionalLimit" => new JurisdictionalLimitViewModel { PID = pid },
			"LayoutDivision" => new LayoutDivisionViewModel { PID = pid },
			_ or "" => throw new InvalidOperationException(),
		};
		...
		public static InformationViewModel CreateInformationType(string type, string? pid = default) => type switch {
			...
			"AvailablePortServices" => new AvailablePortServicesViewModel { PID = pid },
			"ContactDetails" => new ContactDetailsViewModel { PID = pid },
			"Entrance" => new EntranceViewModel { PID = pid },
		...
		public static FeatureViewModel CreateFeatureType(string type, string? pid = default) => type switch {
			"AnchorBerth" => new AnchorBerthViewModel { PID = pid },
			"AnchorageArea" => new AnchorageAreaViewModel { PID = pid },
			"Berth" => new BerthViewModel { PID = pid },
			"BerthPosition" => new BerthPositionViewModel { PID = pid },
			"DockArea" => new DockAreaViewModel { PID = pid },
			"DryDock" => new DryDockViewModel { PID = pid },
			"DumpingGround" => new DumpingGroundViewModel { PID = pid },
			"FloatingDock" => new FloatingDockViewModel { PID = pid },
			"Gridiron" => new GridironViewModel { PID = pid },
			"HarbourAreaAdministrative" => new HarbourAreaAdministrativeViewModel { PID = pid },
			"HarbourAreaSection" => new HarbourAreaSectionViewModel { PID = pid },
			"HarbourBasin" => new HarbourBasinViewModel { PID = pid },
			"HarbourFacility" => new HarbourFacilityViewModel { PID = pid },
			"MooringWarpingFacility" => new MooringWarpingFacilityViewModel { PID = pid },
			"OuterLimit" => new OuterLimitViewModel { PID = pid },
			"PilotBoardingPlace" => new PilotBoardingPlaceViewModel { PID = pid },
			"SeaplaneLandingArea" => new SeaplaneLandingAreaViewModel { PID = pid },
			"Terminal" => new TerminalViewModel { PID = pid },
			"TurningBasin" => new TurningBasinViewModel { PID = pid },
			"WaterwayArea" => new WaterwayAreaViewModel { PID = pid },
	...
	public partial class LimitEntranceViewModel : AssociationViewModel {
		...
		public LimitEntranceViewModel Load(LimitEntrance instance) {
	...
	public partial class ServiceAvailabilityViewModel : AssociationViewModel {
		...
		public ServiceAvailabilityViewModel Load(ServiceAvailability instance) {
	...
	public partial class SubsectionViewModel : AssociationViewModel {
		...
		public SubsectionViewModel Load(Subsection instance) {
	...
	public partial class InfrastructureViewModel : AssociationViewModel {
		...
		public InfrastructureViewModel Load(Infrastructure instance) {
	...
	public partial class PrimaryAuxiliaryFacilityViewModel : AssociationViewModel {
		...
		public PrimaryAuxiliaryFacilityViewModel Load(PrimaryAuxiliaryFacility instance) {
	...
	public partial class DemarcationViewModel : AssociationViewModel {
		...
		public DemarcationViewModel Load(Demarcation instance) {
	...
	public partial class JurisdictionalLimitViewModel : AssociationViewModel {
		...
		public JurisdictionalLimitViewModel Load(JurisdictionalLimit instance) {
	...
	public partial class LayoutDivisionViewModel : AssociationViewModel {
		...
		public LayoutDivisionViewModel Load(LayoutDivision instance) {
	...
	public partial class AvailablePortServicesViewModel : InformationViewModel<AvailablePortServices> {
		...
		public override InformationViewModel<AvailablePortServices> Load(AvailablePortServices instance) {
			featureName.Clear();
			if (instance.featureName is not null) {
				foreach(var e in instance.featureName)
					featureName.Add(new featureNameViewModel().Load(e));
	...
	public partial class EntranceViewModel : InformationViewModel<Entrance> {
		...
		public override InformationViewModel<Entrance> Load(Entrance instance) {
			featureName.Clear();
			if (instance.featureName is not null) {
				foreach(var e in instance.featureName)
					featureName.Add(new featureNameViewModel().Load(e));
	...
	public partial class AnchorBerthViewModel : FeatureViewModel<AnchorBerth> {
		...
		public override FeatureViewModel<AnchorBerth> Load(AnchorBerth instance) {
	...
	public partial class BerthViewModel : FeatureViewModel<Berth> {
		...
		public override FeatureViewModel<Berth> Load(Berth instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class BerthPositionViewModel : FeatureViewModel<BerthPosition> {
		...
		public override FeatureViewModel<BerthPosition> Load(BerthPosition instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class DockAreaViewModel : FeatureViewModel<DockArea> {
		...
		public override FeatureViewModel<DockArea> Load(DockArea instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class DryDockViewModel : FeatureViewModel<DryDock> {
		...
		public override FeatureViewModel<DryDock> Load(DryDock instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class FloatingDockViewModel : FeatureViewModel<FloatingDock> {
		...
		public override FeatureViewModel<FloatingDock> Load(FloatingDock instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class GridironViewModel : FeatureViewModel<Gridiron> {
		...
		public override FeatureViewModel<Gridiron> Load(Gridiron instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class HarbourAreaAdministrativeViewModel : FeatureViewModel<HarbourAreaAdministrative> {
		...
		public override FeatureViewModel<HarbourAreaAdministrative> Load(HarbourAreaAdministrative instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class HarbourAreaSectionViewModel : FeatureViewModel<HarbourAreaSection> {
		...
		public override FeatureViewModel<HarbourAreaSection> Load(HarbourAreaSection instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class HarbourBasinViewModel : FeatureViewModel<HarbourBasin> {
		...
		public override FeatureViewModel<HarbourBasin> Load(HarbourBasin instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class HarbourFacilityViewModel : FeatureViewModel<HarbourFacility> {
		...
		public override FeatureViewModel<HarbourFacility> Load(HarbourFacility instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class MooringWarpingFacilityViewModel : FeatureViewModel<MooringWarpingFacility> {
		...
		public override FeatureViewModel<MooringWarpingFacility> Load(MooringWarpingFacility instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class OuterLimitViewModel : FeatureViewModel<OuterLimit> {
		...
		public override FeatureViewModel<OuterLimit> Load(OuterLimit instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class SeaplaneLandingAreaViewModel : FeatureViewModel<SeaplaneLandingArea> {
		...
		public override FeatureViewModel<SeaplaneLandingArea> Load(SeaplaneLandingArea instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class TerminalViewModel : FeatureViewModel<Terminal> {
		...
		public override FeatureViewModel<Terminal> Load(Terminal instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
	...
	public partial class TurningBasinViewModel : FeatureViewModel<TurningBasin> {
		...
		public override FeatureViewModel<TurningBasin> Load(TurningBasin instance) {
			locationMRN = instance.locationMRN;
			globalLocationNumber = instance.globalLocationNumber;
			featureName.Clear();
			if (instance.featureName is not null) {
