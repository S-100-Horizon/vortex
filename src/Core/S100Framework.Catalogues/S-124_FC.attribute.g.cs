...
namespace S100Framework.AttributeModel.S124.SimpleAttributes
{
	/// <summary>
	...
	/// </summary>
	public class year : S100Framework.AttributeModel.IntegerAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class warningType : S100Framework.AttributeModel.EnumerationAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class warningNumber : S100Framework.AttributeModel.IntegerAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class nameOfSeries : S100Framework.AttributeModel.TextAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class localityIdentifier : S100Framework.AttributeModel.UrnTimeAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class lastNoticeDate : S100Framework.AttributeModel.DateAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class chartPlanNumber : S100Framework.AttributeModel.TextAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class chartNumber : S100Framework.AttributeModel.TextAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class publicationAffected : S100Framework.AttributeModel.TextAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class internationalChartAffected : S100Framework.AttributeModel.TextAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class chartPublicationIdentifier : S100Framework.AttributeModel.UrnTimeAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class intService : S100Framework.AttributeModel.BooleanAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class cancellationDate : S100Framework.AttributeModel.DateTimeAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class referenceCategory : S100Framework.AttributeModel.EnumerationAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class noMessageOnHand : S100Framework.AttributeModel.BooleanAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class publicationTime : S100Framework.AttributeModel.DateTimeAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class navwarnTypeDetails : S100Framework.AttributeModel.CodeListAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class navwarnTypeGeneral : S100Framework.AttributeModel.CodeListAttribute
	{
		[JsonIgnore]
...
namespace S100Framework.AttributeModel.S124.ComplexAttributes
{
	...
	/// </summary>
	public class chartAffected : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
		...
		public String? chartPlanNumber_optional { set { base.AddAttributeValue(new chartPlanNumber { value = value }); } }
		public DateOnly? lastNoticeDate_optional { set { base.AddAttributeValue(new lastNoticeDate { value = value }); } }
		#endregion
	}
	...
	/// </summary>
	public class locationName : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class messageSeriesIdentifier : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class navwarnTitle : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class warningInformation : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
		...
		public int?[] navwarnTypeDetails_optional { set { base.AddAttributeValue([.. value.Select(e=> new navwarnTypeDetails { value = e })]); } }
		#endregion
	}
	...
	/// </summary>
	public class featureReference : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
		...
		#region Optional Attributes
		public String?[] atoNNumber_optional { set { base.AddAttributeValue([.. value.Select(e=> new atoNNumber { value = e })]); } }
	...
	/// </summary>
	public class affectedChartPublications : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
		...
		#region Optional Attributes
		public chartAffected? chartAffected_optional { set { base.AddAttributeValue(value); } }
		public String? chartPublicationIdentifier_optional { set { base.AddAttributeValue(new chartPublicationIdentifier { value = value }); } }
		public String? internationalChartAffected_optional { set { base.AddAttributeValue(new internationalChartAffected { value = value }); } }
		public String? publicationAffected_optional { set { base.AddAttributeValue(new publicationAffected { value = value }); } }
		#endregion
	}
	...
	/// </summary>
	public class generalArea : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
		...
		#region Optional Attributes
		public String? localityIdentifier_optional { set { base.AddAttributeValue(new localityIdentifier { value = value }); } }
		public locationName?[] locationName_optional { set { base.AddAttributeValue(value); } }
		#endregion
	}
	...
	/// </summary>
	public class locality : S100Framework.AttributeModel.ComplexAttribute
	{
		[JsonIgnore]
...
namespace S100Framework.AttributeModel.S124.InformationTypes
{
	...
	/// </summary>
	public class References : S100Framework.AttributeModel.InformationType
	{
		[JsonIgnore]
		...
		#region Optional Attributes
		public messageSeriesIdentifier?[] messageSeriesIdentifier_optional { set { base.AddAttributeValue(value); } }
		#endregion
	}
	...
	/// </summary>
	public class NavwarnPreamble : S100Framework.AttributeModel.InformationType
	{
		[JsonIgnore]
		...
		#region Optional Attributes
		public affectedChartPublications?[] affectedChartPublications_optional { set { base.AddAttributeValue(value); } }
		public generalArea?[] generalArea_optional { set { base.AddAttributeValue(value); } }
		public locality?[] locality_optional { set { base.AddAttributeValue(value); } }
		public navwarnTitle?[] navwarnTitle_optional { set { base.AddAttributeValue(value); } }
		public DateTime? cancellationDate_optional { set { base.AddAttributeValue(new cancellationDate { value = value }); } }
		#endregion
	}
...
namespace S100Framework.AttributeModel.S124.FeatureTypes
{
	using S100Framework.AttributeModel.S124.SimpleAttributes;
	using S100Framework.AttributeModel.S124.ComplexAttributes;
	...
	/// </summary>
	public class NavwarnPart : S100Framework.AttributeModel.FeatureType
	{
		[JsonIgnore]
		...
		#region Optional Attributes
		public int? restriction_optional { set { base.AddAttributeValue(new restriction { value = value }); } }
		...
		public featureReference?[] featureReference_optional { set { base.AddAttributeValue(value); } }
		#endregion
	}
	...
	/// </summary>
	public class NavwarnAreaAffected : S100Framework.AttributeModel.FeatureType
	{
		[JsonIgnore]
...
namespace S100Framework.AttributeModel.S124
{
