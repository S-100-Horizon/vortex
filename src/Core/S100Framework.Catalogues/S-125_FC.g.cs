...
namespace S100Framework.DomainModel.S125 {
	...
	public static class InformationBindings
	{
		...
		public static informationBindingDefinition[] informationBindingDefinitions(string informationType) => informationType switch {
			...
			"WindTurbine" => WindTurbine.informationBindingDefinitions,
			...
			"QualityOfBathymetricData" => QualityOfBathymetricData.informationBindingDefinitions,
	...
	public static class FeatureBindings
	{
		...
		public static featureBindingDefinition[] featureBindingDefinitions(string featureType) => featureType switch {
			...
			"WindTurbine" => WindTurbine.featureBindingDefinitions,
			...
			"QualityOfBathymetricData" => QualityOfBathymetricData.featureBindingDefinitions,
