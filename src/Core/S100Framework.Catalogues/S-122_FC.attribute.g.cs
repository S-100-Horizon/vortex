...
namespace S100Framework.AttributeModel.S122.ComplexAttributes
{
	...
	public class designation : S100Framework.AttributeModel.ComplexAttribute
	{
		...
		#region Optional Attributes
		[JsonIgnore]
		public String? designationScheme_optional {
			set { base.AddAttributeValue(new designationScheme { value = value }); }
			get { return base.GetAttributeValue<designationScheme>(nameof(designationScheme))?.value; }
		}
		[JsonIgnore]
		public String? designationIdentifier_optional {
			set { base.AddAttributeValue(new designationIdentifier { value = value }); }
			get { return base.GetAttributeValue<designationIdentifier>(nameof(designationIdentifier))?.value; }
		}
		[JsonIgnore]
		public int? jurisdiction_optional {
			set { base.AddAttributeValue(new jurisdiction { value = value }); }
...
namespace S100Framework.AttributeModel.S122.InformationAssociation
{
	using S100Framework.AttributeModel.S122.SimpleAttributes;
	...
	public class ProtectedAreaAuthority : S100Framework.AttributeModel.InformationAssociation
	{
		[JsonIgnore]
...
namespace S100Framework.AttributeModel.S122.FeatureAssociation
{
	using S100Framework.AttributeModel.S122.SimpleAttributes;
	using S100Framework.AttributeModel.S122.ComplexAttributes;
...
namespace S100Framework.AttributeModel.S122.FeatureTypes
{
	...
	public class InformationArea : FeatureType
	{
		...
		public categoryOfRelationship categoryOfRelationship { get; set; } = new categoryOfRelationship();
		public actionOrActivity actionOrActivity { get; set; } = new actionOrActivity();
	...
	public class MarineProtectedArea : FeatureType
	{
		...
		public categoryOfMarineProtectedArea categoryOfMarineProtectedArea { get; set; } = new categoryOfMarineProtectedArea();
		...
		#region Optional Attributes
		[JsonIgnore]
		public int?[] categoryOfMarineProtectedArea_optional {
			set { base.AddAttributeValue([.. value.Select(e=> new categoryOfMarineProtectedArea { value = e })]); }
		...
		[JsonIgnore]
		public designation?[] designation_optional {
			set { base.AddAttributeValue(value); }
...
namespace S100Framework.AttributeModel.S122
{
	...
	using S100Framework.AttributeModel.S122.SimpleAttributes;
	using S100Framework.AttributeModel.S122.ComplexAttributes;
	using S100Framework.AttributeModel.S122.FeatureAssociation;
