...
namespace S100Framework.DomainModel.S131 {
	...
	public static class InformationBindings
	{
		...
		public static informationBindingDefinition[] informationBindingDefinitions(string informationType) => informationType switch {
			...
			"AvailablePortServices" => AvailablePortServices.informationBindingDefinitions,
			"ContactDetails" => ContactDetails.informationBindingDefinitions,
			"Entrance" => Entrance.informationBindingDefinitions,
			...
			"HarbourPhysicalInfrastructure" => HarbourPhysicalInfrastructure.informationBindingDefinitions,
			"Layout" => Layout.informationBindingDefinitions,
			"AnchorBerth" => AnchorBerth.informationBindingDefinitions,
			"AnchorageArea" => AnchorageArea.informationBindingDefinitions,
			"AutomatedGuidedVehicle" => AutomatedGuidedVehicle.informationBindingDefinitions,
			"Berth" => Berth.informationBindingDefinitions,
			"BerthPosition" => BerthPosition.informationBindingDefinitions,
			"Bollard" => Bollard.informationBindingDefinitions,
			"DockArea" => DockArea.informationBindingDefinitions,
			"DryDock" => DryDock.informationBindingDefinitions,
			"Dolphin" => Dolphin.informationBindingDefinitions,
			"DumpingGround" => DumpingGround.informationBindingDefinitions,
			"FenderLine" => FenderLine.informationBindingDefinitions,
			"FloatingDock" => FloatingDock.informationBindingDefinitions,
			"Gridiron" => Gridiron.informationBindingDefinitions,
			"HarbourAreaAdministrative" => HarbourAreaAdministrative.informationBindingDefinitions,
			"HarbourAreaSection" => HarbourAreaSection.informationBindingDefinitions,
			"HarbourBasin" => HarbourBasin.informationBindingDefinitions,
			"HarbourFacility" => HarbourFacility.informationBindingDefinitions,
			"LockBasin" => LockBasin.informationBindingDefinitions,
			"LockBasinPart" => LockBasinPart.informationBindingDefinitions,
			"MooringBuoy" => MooringBuoy.informationBindingDefinitions,
			"MooringWarpingFacility" => MooringWarpingFacility.informationBindingDefinitions,
			"OnshorePowerFacility" => OnshorePowerFacility.informationBindingDefinitions,
			"OuterLimit" => OuterLimit.informationBindingDefinitions,
			"PilotBoardingPlace" => PilotBoardingPlace.informationBindingDefinitions,
			"SeaplaneLandingArea" => SeaplaneLandingArea.informationBindingDefinitions,
			"ShipLift" => ShipLift.informationBindingDefinitions,
			"StraddleCarrier" => StraddleCarrier.informationBindingDefinitions,
			"Terminal" => Terminal.informationBindingDefinitions,
			"TurningBasin" => TurningBasin.informationBindingDefinitions,
	...
	public static class FeatureBindings
	{
		...
		public static featureBindingDefinition[] featureBindingDefinitions(string featureType) => featureType switch {
			...
			"HarbourPhysicalInfrastructure" => HarbourPhysicalInfrastructure.featureBindingDefinitions,
			"Layout" => Layout.featureBindingDefinitions,
			"AnchorBerth" => AnchorBerth.featureBindingDefinitions,
			"AnchorageArea" => AnchorageArea.featureBindingDefinitions,
			"AutomatedGuidedVehicle" => AutomatedGuidedVehicle.featureBindingDefinitions,
			"Berth" => Berth.featureBindingDefinitions,
			"BerthPosition" => BerthPosition.featureBindingDefinitions,
			"Bollard" => Bollard.featureBindingDefinitions,
			"DockArea" => DockArea.featureBindingDefinitions,
			"DryDock" => DryDock.featureBindingDefinitions,
			"Dolphin" => Dolphin.featureBindingDefinitions,
			"DumpingGround" => DumpingGround.featureBindingDefinitions,
			"FenderLine" => FenderLine.featureBindingDefinitions,
			"FloatingDock" => FloatingDock.featureBindingDefinitions,
			"Gridiron" => Gridiron.featureBindingDefinitions,
			"HarbourAreaAdministrative" => HarbourAreaAdministrative.featureBindingDefinitions,
			"HarbourAreaSection" => HarbourAreaSection.featureBindingDefinitions,
			"HarbourBasin" => HarbourBasin.featureBindingDefinitions,
			"HarbourFacility" => HarbourFacility.featureBindingDefinitions,
			"LockBasin" => LockBasin.featureBindingDefinitions,
			"LockBasinPart" => LockBasinPart.featureBindingDefinitions,
			"MooringBuoy" => MooringBuoy.featureBindingDefinitions,
			"MooringWarpingFacility" => MooringWarpingFacility.featureBindingDefinitions,
			"OnshorePowerFacility" => OnshorePowerFacility.featureBindingDefinitions,
			"OuterLimit" => OuterLimit.featureBindingDefinitions,
			"PilotBoardingPlace" => PilotBoardingPlace.featureBindingDefinitions,
			"SeaplaneLandingArea" => SeaplaneLandingArea.featureBindingDefinitions,
			"ShipLift" => ShipLift.featureBindingDefinitions,
			"StraddleCarrier" => StraddleCarrier.featureBindingDefinitions,
			"Terminal" => Terminal.featureBindingDefinitions,
			"TurningBasin" => TurningBasin.featureBindingDefinitions,
