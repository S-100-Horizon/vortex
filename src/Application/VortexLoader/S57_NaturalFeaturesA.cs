            ...
            while (cursor.MoveNext()) {
                ...
                switch (fcSubtype) {
                    ...
                    case 5: { //  LNDARE // SKIN OF EARTH
                            ...
                            bufferSurface["edition"] = ImporterNIS.s101version;
                            bufferSurface["json"] = System.Text.Json.JsonSerializer.Serialize(instance, jsonSerializerOptions);
                            bufferSurface["informationbindings"] = System.Text.Json.JsonSerializer.Serialize((instance as FeatureNode)!.GetInformationBindings(), ImporterNIS.jsonInformationTypeSerializerOptions);
                    ...
                    case 10: {    // LNDRGN
                            ...
                            if (current.CATLND != default) {
                                ...
                                if (categoryOfLandRegion is not null && categoryOfLandRegion.Any())
                                    instance.categoryOfLandRegion_optional = categoryOfLandRegion;
                            }
                    ...
                    case 25: {    // SEAARE
                            ...
                            if (current.CATSEA.HasValue) {
                                instance.categoryOfSeaArea_optional = EnumHelper.GetEnumValue(current.CATSEA.Value);
                            }
