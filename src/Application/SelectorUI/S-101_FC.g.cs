...
namespace S100Framework.DomainModel.S101.SimpleAttributes
{
	/// <summary>
	...
	/// </summary>
	public class basedOnFixedMarks : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "basedOnFixedMarks";
		[JsonIgnore]
	...
	/// </summary>
	public class beaconShape : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "beaconShape";
		[JsonIgnore]
	...
	/// <summary>
	/// The bridge’s primary shape and/or construction material.
	/// </summary>
	public class bridgeConstruction : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "bridgeConstruction";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Viaduct", "A structure consisting of a series of arches or towers supporting a roadway, waterway, etc., across a depression, etc.",2),
				new listedValue("Pontoon Bridge", "A fixed floating bridge supported by pontoons.",3),
	...
	/// <summary>
	/// A specific role that describes the purpose of a bridge.
	/// </summary>
	public class bridgeFunction : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "bridgeFunction";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Vehicular", "Of, relating to, or designed for vehicles and especially motor vehicles.",1),
				new listedValue("Rail", "Of, relating to, or designed for vehicles that run on a guiding track(s), especially trains.",2),
	...
	/// </summary>
	public class buildingShape : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "buildingShape";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class buoyShape : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "buoyShape";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// The depth below the seabed to which an object is buried.
	/// </summary>
	public class buriedDepth : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "buriedDepth";
		[JsonIgnore]
	...
	/// </summary>
	public class callSign : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "callSign";
		[JsonIgnore]
	...
	/// </summary>
	public class categoryOfAirportAirfield : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfAirportAirfield";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Civil Aeroplane Airport", "A large airfield usually equipped with a control tower, hangars and accommodation for the receiving and discharging of passengers or cargo.",2),
				new listedValue("Military Heliport", "A landing place for helicopters controlled by the military.",3),
				new listedValue("Civil Heliport", "A landing place for helicopters, often the roof of a building.",4),
				new listedValue("Glider Airfield", "An area of land set aside for the take-off and landing of gliders.",5),
				new listedValue("Small Planes Airfield", "An area of land set aside for the take-off and landing of small aeroplanes.",6),
	...
	/// </summary>
	public class categoryOfAnchorage : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfAnchorage";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfBuiltUpArea : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfBuiltUpArea";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Settlement", "A continuously occupied concentration of tents or lightweight fixed structures (for example: huts) serving as residences.",2),
				new listedValue("Village", "A self-contained group of houses and associated buildings, usually in a country area.",3),
				new listedValue("Town", "An inhabited place larger and more regularly built and with more complete and independent local government than a village but not incorporated as a city.",4),
	...
	/// </summary>
	public class categoryOfCable : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfCable";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Power Line", "A cable that transmits or distributes electrical power.",1),
				new listedValue("Transmission Line", "Multiple un-insulated cables usually supported by steel lattice towers. Such features are generally more prominent than normal power lines.",3),
				new listedValue("Mooring Cable", "A chain or very strong fibre or wire rope used to anchor or moor vessels or buoys.",6),
				new listedValue("Ferry", "A vessel for transporting passengers, vehicles, and/or goods across a stretch of water, especially as a regular service.",7),
	...
	/// </summary>
	public class categoryOfCanal : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfCanal";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfCardinalMark : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfCardinalMark";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfCheckpoint : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfCheckpoint";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfCoastline : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfCoastline";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Flat Coast", "A level coast with no obvious topographic features.",2),
				new listedValue("Glacier, Seaward End", "Projecting seaward extension of glacier, usually afloat.",6),
				new listedValue("Mangrove", "One of several genera of tropical trees or shrubs which produce many prop roots and grow along low-lying coasts into shallow water.",7),
	...
	/// </summary>
	public class categoryOfConveyor : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfConveyor";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Belt Conveyor", "A conveyor along which material or people are transported by means of a moving belt.",2),
	...
	/// </summary>
	public class categoryOfCrane : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfCrane";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Sheerlegs", "A tripodal structure used in dockyards and harbours for stepping masts or lifting loads in to and out of vessels.",3),
				new listedValue("Travelling Crane", "A crane mounted on rails (track) that can move (usually parallel to the wharf face) in order to load and unload cargo vessels.",4),
	...
	/// </summary>
	public class categoryOfDam : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfDam";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfDock : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfDock";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfDolphin : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfDolphin";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfDumpingGround : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfDumpingGround";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Chemical Waste Dumping Ground", "An area at sea where chemical waste is dumped.",2),
				new listedValue("Nuclear Waste Dumping Ground", "An area at sea where nuclear waste is dumped.",3),
				new listedValue("Explosives Dumping Ground", "An area at sea where explosives are dumped.",4),
	...
	/// </summary>
	public class categoryOfFence : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfFence";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfFerry : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfFerry";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Free Moving Ferry", "A ferry which may have routes that vary with weather, tide and traffic.",1),
				new listedValue("Cable Ferry", "A ferry that follows a fixed route guided by a cable.",2),
	...
	/// </summary>
	public class categoryOfFishingFacility : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfFishingFacility";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Fishing Stake", "Poles or stakes placed in shallow water to outline a fishing ground or to catch fish.",1),
				new listedValue("Fish Trap", "A structure (usually portable) for catching fish.",2),
	...
	/// </summary>
	public class categoryOfFogSignal : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfFogSignal";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Reed", "A reed uses compressed air and emits a weak, high pitched sound.",5),
	...
	/// </summary>
	public class categoryOfFortifiedStructure : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfFortifiedStructure";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Castle", "A large fortified building or structure.",1),
				new listedValue("Fort", "A fortified enclosure, building, or position able to be defended against an enemy.",2),
				new listedValue("Battery", "A fortified structure on which artillery is mounted.",3),
				new listedValue("Blockhouse", "A concrete structure strengthened to give protection against enemy fire, with apertures to allow defensive gunfire.",4),
				new listedValue("Fortified Tower", "A small circular fort with very thick walls (for example Martello tower).",5),
				new listedValue("Redoubt", "An outwork or fieldwork usually square or polygonal and without flanking defences.",6),
	...
	/// </summary>
	public class categoryOfGate : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfGate";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Flood Barrage Gate", "An opening gate used to control flood water.",2),
				new listedValue("Caisson", "A steel structure used for closing the entrance of locks, wet and dry docks.",3),
				new listedValue("Lock Gate", "Pair of massive hinged doors at each end of a lock.",4),
	...
	/// </summary>
	public class categoryOfHarbourFacility : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfHarbourFacility";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfHulk : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfHulk";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Historic Ship", "A ship of historical interest permanently moored as a tourist attraction.",2),
				new listedValue("Floating Museum", "A permanently moored floating structure (for example: an old ship) that is used as a museum.",3),
				new listedValue("Floating Accommodation", "A permanently moored floating structure (for example: an old ship) that is used for accommodation.",4),
				new listedValue("Floating Breakwater", "A permanently moored floating structure, often constructed from old ships, used as a breakwater.",5),
	...
	/// </summary>
	public class categoryOfIce : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfIce";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfInstallationBuoy : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfInstallationBuoy";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfLandRegion : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfLandRegion";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Marsh", "An area of wet, often spongy ground that is subject to frequent flooding or tidal inundations, but not considered to be continually under water. It is characterized by the growth of non woody plants and by the lack of trees.",2),
				new listedValue("Bog", "Wet spongy ground consisting of decaying vegetation, which retains stagnant water, too soft to bear the weight of any heavy body.",3),
				new listedValue("Heathland", "A tract of wasteland peat bog, usually covered by a low scrubby growth, but may have scattered small open water holes.",4),
				new listedValue("Mountain Range", "A series of connected and aligned mountains or mountain ridges.",5),
				new listedValue("Lowlands", "Low and relatively level land at a lower elevation than adjoining areas.",6),
				new listedValue("Canyon Lands", "A relatively narrow, deep depression with steep sides, the bottom of which generally has a continuous slope.",7),
				new listedValue("Paddy Field", "A piece of land set aside for crops which are periodically flooded (for example rice paddy).",8),
				new listedValue("Agricultural Land", "Of or pertaining to the science or practice of cultivating the soil and rearing animals.",9),
				new listedValue("Savanna/Grassland", "An open grassy plain with few or no trees in a tropical or subtropical region; a tract covered mainly by grasses that have little or no woody tissue.",10),
				new listedValue("Parkland", "A piece of ground kept for ornament and/or recreation or maintained in its natural state as a public property or area.",11),
				new listedValue("Swamp", "An area of spongy land saturated with water. It may have a shallow covering of water, usually with a considerable amount of vegetation appearing above the surface.",12),
				new listedValue("Landslide", "The sliding down of a mass of land on a mountain or cliff-side; land which has so fallen.",13),
				new listedValue("Lava Flow", "The substance that results from the cooling of molten rock.",14),
				new listedValue("Salt Pan", "Shallow pools of brackish water used for the natural evaporation of sea water to obtain salt.",15),
				new listedValue("Moraine", "Any accumulation of loose material deposited by a glacier.",16),
				new listedValue("Crater", "Bowl-shaped cavity, at the summit or on the side of a volcano.",17),
				new listedValue("Cave", "A natural subterranean chamber or series of chambers open to the earth's surface.",18),
				new listedValue("Rock Column or Pinnacle", "Any high tower or spire-shaped pillar of rock, alone or cresting a summit.",19),
	...
	/// </summary>
	public class categoryOfLandmark : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfLandmark";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfLateralMark : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfLateralMark";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfLight : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfLight";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfMarineFarmCulture : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfMarineFarmCulture";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Crustaceans", "Hard shelled animals, for example crabs or lobsters.",1),
				new listedValue("Edible Bivalve Molluscs", "A two-part hinged external shell covering that contains a soft-bodied invertebrate.",2),
				new listedValue("Fish", "Vertebrate cold blooded animal with gills, living in water.",3),
	...
	/// </summary>
	public class categoryOfMilitaryPracticeArea : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfMilitaryPracticeArea";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// Classification of an area in which vessels may be secured to mooring buoys.
	/// </summary>
	public class categoryOfMooringArea : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfMooringArea";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfNavigationLine : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfNavigationLine";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfObstruction : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfObstruction";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Wellhead", "A submarine structure projecting some distance above the seabed and capping a temporarily abandoned or suspended oil or gas well.",2),
				new listedValue("Diffuser", "A structure on an outfall through which liquids are discharged. The structure will usually project above the level of the outfall and can be an obstruction to navigation.",3),
				new listedValue("Crib", "A permanent marine structure usually designed to support or elevate pipelines; especially a structure enclosing a screening device at the offshore end of a potable water intake pipe. The structure is commonly a heavy timber enclosure that has been sunken with rocks or other debris.",4),
				new listedValue("Fish Haven", "Areas established by private interests, usually sport fishermen, to simulate natural reefs and wrecks that attract fish. The reefs are constructed by dumping assorted junk in areas which may be of very small extent or may stretch a considerable distance along a depth contour.",5),
				new listedValue("Foul Area", "An area of numerous unidentified dangers to navigation. The area serves as a warning to the mariner that all dangers are not identified individually and that navigation through the area may be hazardous.",6),
				new listedValue("Ice Boom", "Floating barriers, anchored to the bottom, used to deflect the path of floating ice in order to prevent the obstruction of locks, intakes, etc., and to prevent damage to bridge piers and other structures.",8),
				new listedValue("Ground Tackle", "Equipment such as anchors, concrete blocks, chains and cables, etc., used to position floating structures such as trot and mooring buoys etc.",9),
				new listedValue("Boom", "A floating barrier used to protect a river or harbour mouth or to create a sheltered area for storage purposes.",10),
				new listedValue("Wave Energy Device", "A device to extract energy from the surface motion of ocean waves or from pressure fluctuations below the surface.",12),
				new listedValue("Subsurface Ocean Data Acquisition System", "A submerged device, not being a ship, together with its appurtenant equipment, deployed at sea essentially for the purpose of collecting, storing or transmitting samples or data relating to the marine environment.",13),
				new listedValue("Artificial Reef", "A man-made structure that may mimic some of the characteristics of a natural reef, intended to attract sea life.",14),
				new listedValue("Template", "A structure placed on the seafloor below a drilling rig to guide the drill.",15),
				new listedValue("Manifold", "A large steel structure up to 20 metres in height above the seafloor, or a steel frame secured to the seafloor with piles to anchor the end of a submarine pipeline, for delivery to a production platform.",16),
				new listedValue("Submerged Pingo", "A hill of soil-covered ice pushed up by hydrostatic pressure in an area of permafrost that is located underwater.",17),
				new listedValue("Remains of Platform", "The distributed remains of a platform.",18),
				new listedValue("Scientific Instrument", "An instrument used for scientific purposes.",19),
				new listedValue("Underwater Turbine", "Any of various machines having a rotor, usually with vanes or blades, driven by the pressure, momentum, or reactive thrust of a moving fluid, as steam, water, hot gases, or air, either occurring in the form of free jets or as a fluid passing through and entirely filling a housing around the rotor and is located underwater.",20),
				new listedValue("Active Submarine Volcano", "An active seabed volcano, which may be submerged or projecting above the water at the chart sounding datum.",21),
	...
	/// </summary>
	public class categoryOfOffshorePlatform : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfOffshorePlatform";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// Classification of an area at sea within which there are production facilities.
	/// </summary>
	public class categoryOfOffshoreProductionArea : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfOffshoreProductionArea";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Wave Farm", "A collection of collocated devices which harness wave energy and are organized as a single power generation unit.",2),
				new listedValue("Current Farm", "A collection of collocated devices which harness current (for example tidal) energy and are organized as a single power generation unit.",3),
				new listedValue("Tank Farm", "A collection of collocated large-capacity tanks in which petroleum, natural gas, or liquid petrochemicals are stored.",4),
	...
	/// </summary>
	public class categoryOfOilBarrier : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfOilBarrier";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// Classification of opening structures spanning and providing passage over a gap or barrier, such as a river or roadway.
	/// </summary>
	public class categoryOfOpeningBridge : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfOpeningBridge";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Lifting Bridge", "A movable bridge (or span thereof) which is capable of being lifted vertically to allow vessels to pass beneath.",4),
	...
	/// </summary>
	public class categoryOfPile : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfPile";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfPilotBoardingPlace : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfPilotBoardingPlace";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// Classification of a pipe systems use.
	/// </summary>
	public class categoryOfPipelinePipe : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfPipelinePipe";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Outfall Pipe", "A pipe (generally a sewer or drainage pipe) discharging into the sea or a river.",2),
				new listedValue("Intake Pipe", "A pipe taking water from a river or other body of water, to drive a mill or supply a canal, waterworks, etc.",3),
				new listedValue("Sewer", "A pipe in a sewage system for carrying water or sewage to a disposal area.",4),
				new listedValue("Bubbler System", "A submerged pipe from which warm water bubbles, preventing the surrounding water from freezing.",5),
	...
	/// </summary>
	public class categoryOfPreference : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfPreference";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfProductionArea : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfProductionArea";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Quarry", "An open-air excavation for the extraction of stone intended principally for use in construction.",1),
				new listedValue("Mine", "An excavation made in the terrain for the purpose of extracting and/or exploiting natural resources.",2),
				new listedValue("Stockpile", "A reserve stock of material, equipment or other supplies.",3),
				new listedValue("Power Station Area", "A facility including one or more buildings and equipment used for power generation.",4),
				new listedValue("Refinery Area", "A facility where petroleum and/or petroleum products are refined.",5),
				new listedValue("Timber Yard", "An open tract for the storage of wooden lumber and timbers.",6),
				new listedValue("Factory Area", "A group of buildings where goods are manufactured.",7),
				new listedValue("Tank Farm", "A collection of collocated large-capacity tanks in which petroleum, natural gas, or liquid petrochemicals are stored.",8),
				new listedValue("Wind Farm", "A collection of wind turbines that are collocated and are organized as a single power generation unit.",9),
				new listedValue("Slag Heap/Spoil Heap", "Hill of refuse from a mine, industrial plant etc. on land.",10),
	...
	/// <summary>
	/// Classification of the pylon based on the service it is supporting.
	/// </summary>
	public class categoryOfPylon : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfPylon";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Power Transmission Pylon/Pole", "A pylon or pole that supports one or more power lines.",1),
				new listedValue("Telephone/Telegraph Pylon/Pole", "A pylon or pole that supports one or more communication lines.",2),
				new listedValue("Aerial Cableway Pylon", "A tower or pylon supporting steel cables which convey cars, buckets, or other suspended carrier units.",3),
				new listedValue("Bridge Pylon/Tower", "A tower and/or pylon from which the deck of a bridge is suspended.",4),
	...
	/// </summary>
	public class categoryOfRadarStation : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfRadarStation";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfRadarTransponderBeacon : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfRadarTransponderBeacon";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfRadioStation : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfRadioStation";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfRescueStation : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfRescueStation";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Rescue Station with Rocket", "A life saving station equipped with line-carrying rocket apparatus.",2),
				new listedValue("Refuge for Shipwrecked Mariners", "Shelter or protection from danger or distress at sea.",4),
				new listedValue("Refuge for Intertidal Area Walkers", "Shelter or protection from danger in areas exposed to extreme and sudden tides or tidal streams.",5),
				new listedValue("Lifeboat Lying at a Mooring", "A place where a lifeboat is moored ready for use.",6),
	...
	/// </summary>
	public class categoryOfRestrictedArea : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfRestrictedArea";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Degaussing Range", "An area, usually about two cables diameter, within which ships' magnetic fields may be measured; sensing instruments and cables are installed on the seabed in the range and there are cables leading from the range to a control position ashore.",8),
				...
				new listedValue("Swimming Area", "An area in which people may swim and therefore vessel movement may be restricted.",18),
				...
				new listedValue("Dredging Area", "An area where dredging is taking place.",21),
				new listedValue("Fish Sanctuary", "A place where fish (including shellfish and crustaceans) are protected.",22),
				new listedValue("Ecological Reserve", "A tract of land or water managed so as to preserve the relation of plants and living creatures to each other and to their surroundings.",23),
				new listedValue("No Wake Area", "An area in which a vessels' speed must be reduced in order to reduce the size of the wake it produces.",24),
	...
	/// </summary>
	public class categoryOfRoad : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfRoad";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Major Road", "A hard surfaced (metalled) road; a main through route.",2),
				new listedValue("Minor Road", "A secondary road for local traffic.",3),
				new listedValue("Track/Path", "Track - a rough path or way formed by use. Path - a way or track laid down for walking or made by continual treading.",4),
	...
	/// </summary>
	public class categoryOfSchedule : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSchedule";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfSeaArea : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSeaArea";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Bank", "An elevation of the seafloor, at depths generally less than 200 m, but sufficient for safe surface navigation, commonly found on the continental shelf or near an island.",3),
				new listedValue("Deep", "In oceanography, an obsolete term which was generally restricted to depths greater than 6,000 m.",4),
				new listedValue("Bay", "A wide indentation in the coastline generally smaller than a gulf and larger than a cove. For the purposes of the United Nations Convention on the Law of the Sea, a bay is a well-marked indentation whose penetration is in such proportion to the width of its mouth as to contain land locked waters and constitute more than a mere curvature of the coast.",5),
				new listedValue("Trench", "A long, deep, asymmetrical depression with relatively steep sides, that is associated with subduction.",6),
				new listedValue("Basin", "A depression of the seafloor more or less equidimensional in plan and of variable extent.",7),
				new listedValue("Mud Flats", "A level tract of land, as the bed of a dry lake or an area frequently uncovered at low tide. Usually in plural.",8),
				new listedValue("Reef", "A shallow elevation composed of consolidated material that may constitute a hazard to surface navigation.",9),
				new listedValue("Ledge", "A rocky formation continuous with and fringing the shore.",10),
				new listedValue("Canyon", "An elongated, narrow, steep-sided depression that generally deepens down-slope.",11),
				new listedValue("Narrows", "A navigable narrow part of a bay, strait, river, etc.",12),
				new listedValue("Shoal", "A shallow elevation composed of unconsolidated material that may constitute a hazard to surface navigation.",13),
				new listedValue("Knoll", "A distinct elevation with a rounded profile less than 1000m above the surrounding relief as measured from the deepest isobath that surrounds most of the feature.",14),
				new listedValue("Ridge", "An elongated elevation of varying complexity and size, generally having steep sides.",15),
				new listedValue("Seamount", "A distinct generally equidimensional elevation greater than 1000m above the surrounding relief as measured from the deepest isobath that surrounds most of the feature.",16),
				new listedValue("Pinnacle", "Any high tower or spire-shaped pillar or rock or coral, alone or cresting a summit. It may extend above the surface of the water. It may or may not be a hazard to surface navigation.",17),
				new listedValue("Abyssal Plain", "An extensive, flat, gently sloping or nearly level region at abyssal depths.",18),
				new listedValue("Plateau", "A large, relatively flat elevation that is higher than the surrounding relief with one or more relatively steep sides.",19),
				new listedValue("Spur", "A subordinate ridge protruding from a larger feature.",20),
				new listedValue("Shelf", "The flat or gently sloping region adjacent to a continent or around an island that extends from the low water line to a depth, generally about 200m, where there is a marked increase in downward slope.",21),
				new listedValue("Trough", "A long depression generally wide and flat bottomed with symmetrical and parallel sides.",22),
				new listedValue("Saddle", "A broad pass or col in a ridge, rise or other elevation.",23),
				new listedValue("Abyssal Hill", "An isolated small elevation on the deep seafloor.",24),
				new listedValue("Apron", "A gently dipping slope, with a smooth surface, commonly found around groups of islands and seamounts.",25),
				new listedValue("Archipelagic Apron", "A gentle slope with a generally smooth surface of the seafloor, characteristically found around groups of islands or seamounts.",26),
				new listedValue("Borderland", "A region adjacent to a continent, normally occupied by or bordering a shelf and sometimes emerging as islands, that is irregular or blocky in plan or profile, with depths well in excess of those typical of a shelf.",27),
				new listedValue("Continental Margin", "The zone, generally consisting of shelf, slope and continental rise, separating the continent from the deep seafloor or abyssal plain or plain. Occasionally a trench may be present in place of a continental rise.",28),
				new listedValue("Continental Rise", "A gentle slope rising from the oceanic depths towards the foot of a continental slope.",29),
				new listedValue("Escarpment", "An elongated, characteristically linear, steep slope separating horizontal or gently sloping areas of the seafloor.",30),
				new listedValue("Fan", "A relatively smooth, depositional feature continuously deepening away from a sediment source commonly located at the lower termination of a canyon or canyon system.",31),
				new listedValue("Fracture Zone", "A long narrow zone of irregular topography formed by the movement of tectonic plates associated with an offset of a spreading ridge axis, characterized by steep-sided and/or asymmetrical ridges, troughs or escarpments.",32),
				new listedValue("Gap", "A narrow break in a ridge, rise or other elevation.",33),
				new listedValue("Guyot", "A seamount having a comparatively smooth flat top.",34),
				new listedValue("Hill", "A distinct elevation generally of irregular shape, less than 1000m above the surrounding relief as measured from the deepest isobath that surrounds most of the feature.",35),
				new listedValue("Hole", "A depression of limited extent with all sides rising steeply from a relatively flat bottom.",36),
				new listedValue("Levee", "A depositional embankment bordering a canyon, valley or sea channel.",37),
				new listedValue("Median Valley", "The axial depression of the mid-oceanic ridge system.",38),
				new listedValue("Moat", "An annular or partially annular depression commonly located at the base of seamounts, islands and other isolated elevations.",39),
				new listedValue("Mountains", "A natural elevation of the earth's surface rising more or less abruptly from the surrounding level, and attaining an altitude which, relatively to adjacent elevations, is impressive or notable.",40),
				new listedValue("Peak", "A conical or pointed elevation on a larger feature such as a seamount.",41),
				new listedValue("Province", "A geographically distinct region with a number of shared physiographic characteristics that contrast with those in the surrounding areas. This term should be modified with the generic term that best describes the majority of features in the region, for example \"Seamount\" in Baja California Seamount Province.",42),
				new listedValue("Rise", "A broad elevation that generally rises gently and smoothly from the surrounding relief.",43),
				new listedValue("Sea Channel", "An elongated, meandering depression, usually occurring on a gently sloping plain or fan.",44),
				new listedValue("Seamount Chain", "Several seamounts in linear or arcuate alignment.",45),
				new listedValue("Shelf-Edge", "The line along which there is a marked increase in slope at the seaward margin of a shelf.",46),
				new listedValue("Sill", "A relatively shallow barrier between BASINS that may inhibit water movement.",47),
				new listedValue("Slope", "The sloping region that deepens from a shelf to the point where there is a general decrease in gradient.",48),
				new listedValue("Terrace", "A flat or gently sloping region, generally long and narrow, bounded along one edge by a steeper descending slope and along the other by a steeper ascending slope.",49),
				new listedValue("Valley", "An elongated depression that generally widens and deepens down-slope.",50),
				new listedValue("Canal", "An artificial waterway with no flow, or a controlled flow, used for navigation, or for draining or irrigating land (ditch).",51),
				new listedValue("Lake", "A large body of water entirely surrounded by land.",52),
				new listedValue("River", "A relatively large natural stream of water.",53),
				new listedValue("Reach", "A straight section of a river, especially a navigable river between two bends; or an arm of the sea extending into the land.",54),
	...
	/// </summary>
	public class categoryOfShorelineConstruction : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfShorelineConstruction";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Breakwater", "A structure protecting a shore area, harbour, anchorage, or basin from waves.",1),
				new listedValue("Groyne", "A low artificial wall-like structure of durable material extending from the land to seaward for a particular purpose, such as to protect the coast or to force a current to scour a channel.",2),
				new listedValue("Mole", "A form of breakwater alongside which vessels may lie on the sheltered side only; in some cases it may lie entirely within an artificial harbour, permitting vessels to lie along both sides.",3),
				new listedValue("Pier (Jetty)", "A long, narrow structure extending into the water to afford a berthing place for vessels, to serve as a promenade, etc.",4),
				new listedValue("Promenade Pier", "A pier built only for recreational purposes.",5),
				new listedValue("Wharf", "A structure serving as a berthing place for vessels.",6),
				new listedValue("Training Wall", "A wall or bank, often submerged, built to direct or confine the flow of a river or tidal current, or to promote a scour action.",7),
				new listedValue("Rip Rap", "A layer of broken rock, cobbles, boulders, or fragments of sufficient size to resist the erosive forces of flowing water and wave action.",8),
				new listedValue("Revetment", "Facing of stone or other material, either permanent or temporary, placed along the edge of a stream, river or canal to stabilize the bank and to protect it from the erosive action of the stream.",9),
				new listedValue("Sea Wall", "An embankment or wall for protection against waves or tidal action along a shore or water front.",10),
				new listedValue("Landing Steps", "Steps at the shoreline as the connection between land and water on different levels.",11),
				new listedValue("Ramp", "A sloping structure which may include rails that can either be used, as a landing place, at variable water levels, for small vessels, landing ships, or a ferry boat, or for hauling a cradle carrying a vessel.",12),
				new listedValue("Slipway", "The prepared and usually reinforced inclined surface on which keel- and bilge-blocks are laid for supporting a vessel under construction.",13),
				new listedValue("Fender", "A protective structure designed to cushion the impact of a vessel and prevent damage.",14),
				new listedValue("Solid Face Wharf", "A wharf consisting of a solid wall of concrete, masonry, wood etc., such that the water cannot circulate freely under the wharf. The type of construction affects ship-handling; for example, a solid face wharf may give shelter from tidal streams, but under certain circumstances a cushion of water may build up between such a wharf and a ship attempting to berth at it, causing difficulties in ship handling.",15),
				new listedValue("Open Face Wharf", "A wharf supported on piles or other structures which allow free circulation of water under the wharf.",16),
				new listedValue("Log Ramp", "An inclined plane used to dump logs into the water for transport, or to haul logs out of the water for processing.",17),
				new listedValue("Swimming Facility", "An artificial pool or swimming enclosure, especially one in the open air, which may be constructed of wire mesh or heavy netting supported by cables, buoys or piles, for swimming in.",20),
	...
	/// </summary>
	public class categoryOfSignalStationTraffic : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSignalStationTraffic";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Berthing Signal Station", "A signal station for the control of vessels when berthing.",4),
	...
	/// </summary>
	public class categoryOfSignalStationWarning : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSignalStationWarning";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Time", "An accurate signal marking a specified time or time interval. It is used primarily for determining errors of timepieces. Such signals are usually sent from an observatory by radio, but visual signals are used at some ports.",9),
	...
	/// </summary>
	public class categoryOfSiloTank : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSiloTank";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfSlope : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSlope";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Cutting", "An excavation through high ground for a road, canal, etc.",1),
				new listedValue("Embankment", "A man-made raised long mound of earth or other material.",2),
				new listedValue("Dune", "A mound, ridge or hill of drifted material on the sea coast or in a desert.",3),
				new listedValue("Hill", "A small isolated elevation, smaller than a mountain.",4),
				new listedValue("Pingo", "A dome-shaped hill formed in a permafrost area when the hydrostatic pressure of freezing ground water causes the upheaval of a layer of frozen ground.",5),
	...
	/// </summary>
	public class categoryOfSmallCraftFacility : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSmallCraftFacility";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Visitors Berth", "A berth set aside for the use of visiting vessels.",1),
				new listedValue("Nautical Club", "A club for mariners generally associated with other small craft facilities.",2),
				new listedValue("Boat Hoist", "A hoist for lifting boats out of the water.",3),
				new listedValue("Sailmaker", "A place where sails are made or may be taken for repair.",4),
				new listedValue("Boatyard", "A place on shore where boats may be built, stored and repaired.",5),
				new listedValue("Public Inn", "A public house providing food, drink and accommodation.",6),
				new listedValue("Restaurant", "A commercial establishment serving food.",7),
				new listedValue("Chandler", "A dealer in ships' supplies.",8),
				new listedValue("Provisions", "A place where food and other such supplies are available.",9),
				new listedValue("Doctor", "A place where a doctor is available to provide medical attention.",10),
				new listedValue("Pharmacy", "A place where medical drugs are dispensed.",11),
				new listedValue("Water Tap", "A place where fresh water is available.",12),
				new listedValue("Fuel Station", "A place where fuel is available.",13),
				new listedValue("Electricity Outlet", "A place where a connection to an electrical supply is available.",14),
				new listedValue("Bottle Gas", "A place where bottled gas is available.",15),
				new listedValue("Showers", "A place where showers are available.",16),
				new listedValue("Launderette", "A place where there are facilities for washing clothes.",17),
				new listedValue("Public Toilets", "A place where toilets are available for public use.",18),
				new listedValue("Post Box", "A place where mail may be posted.",19),
				new listedValue("Public Telephone", "A place where a telephone is available for public use.",20),
				new listedValue("Refuse Bin", "A place where refuse may be dumped.",21),
				new listedValue("Car Park", "A place where cars may be parked.",22),
				new listedValue("Parking for Boats and Trailers", "A place on shore where boats and/or trailers may be parked.",23),
				new listedValue("Caravan Site", "A place where caravans may be parked or where caravan accommodation is provided.",24),
				new listedValue("Camping Site", "A place where visitors may pitch tents and camp.",25),
				new listedValue("Sewage Pump-Out Station", "A place where sewage may be pumped off a vessel.",26),
				new listedValue("Emergency Telephone", "A place where a telephone is available for emergency use only.",27),
				new listedValue("Landing/Launching Place for Boats", "A place where boats may be landed or launched.",28),
				new listedValue("Scrubbing Berth", "A place where vessels may berth for the purpose of careening.",30),
				new listedValue("Picnic Area", "A place where people may go to eat a picnic.",31),
	...
	/// </summary>
	public class categoryOfSpecialPurposeMark : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfSpecialPurposeMark";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfTemporalVariation : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfTemporalVariation";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// Classification of a covered or partially covered area where different use types of vessel can berth.
	/// </summary>
	public class categoryOfStructure : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfStructure";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Boathouse", "A building or shed, usually built partly over water, for sheltering a boat or boats.",1),
				new listedValue("Covered Bulk Terminal", "A covered or partially covered terminal for the handling of bulk materials such as iron ore, coal, etc.",2),
				new listedValue("Covered Wharf", "A covered or partially covered structure serving as a berthing place for vessels.",3),
	...
	/// </summary>
	public class categoryOfTidalStream : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfTidalStream";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfVegetation : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfVegetation";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Bush", "A shrub or clump of shrubs with stems of moderate length.",3),
				new listedValue("Deciduous Wood", "A wood with trees that shed their leaves annually.",4),
				new listedValue("Coniferous Wood", "A wood with evergreen trees of a group usually bearing cones, including yews, cedars and redwoods.",5),
				new listedValue("Wood in General (inc Mixed Wood)", "Growing trees densely occupying a tract of land.",6),
				new listedValue("Reed", "Any of various water or marsh plants with a firm stem. (Concise Oxford English Dictionary)",11),
				new listedValue("Tree in General", "An individual woody perennial plant, typically having a single stem or trunk growing to a considerable height and bearing lateral branches at some distance from the ground.",13),
				new listedValue("Evergreen Tree", "Having green foliage all the year round.",14),
				new listedValue("Coniferous Tree", "A cone-bearing, needle-leaved or scale-leaved evergreen tree.",15),
				new listedValue("Palm Tree", "A tropical or sub-tropical tree, shrub or vine having a tall, unbranched, columnar trunk. The trunk is crowned by a tuft or large, pleated fan or feather shaped leaves with stout sheathing and often prickly petioles (stalks), the persistent bases of which frequently clothe the trunk.",16),
				new listedValue("Nipa Palm Tree", "A rare palm tree with regular branching involving equal or sub-equal division of the apex that results in forking.",17),
				new listedValue("Casuarina Tree", "A tree characterized by slender, green, often drooping branches that are deeply grooved and that bear, at intervals, whorls of tine leaves.",18),
				new listedValue("Eucalypt Tree", "An instance of a large genus of mostly very large trees (90 metres).",19),
	...
	/// </summary>
	public class categoryOfWaterTurbulence : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfWaterTurbulence";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Eddies", "Circular movements of water usually formed where currents pass obstructions, between two adjacent currents flowing counter to each other, or along the edge of a permanent current.",2),
				new listedValue("Overfalls", "Short, breaking waves occurring when a strong current passes over a shoal or other submarine obstruction or meets a contrary current or wind.",3),
	...
	/// <summary>
	/// Classification of marine vegetation of the algae class.
	/// </summary>
	public class categoryOfWeedKelp : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfWeedKelp";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class categoryOfWreck : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfWreck";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Non-Dangerous Wreck", "A wreck which is not considered to be dangerous to surface navigation.",1),
				new listedValue("Dangerous Wreck", "A wreck submerged at such a depth as to be considered dangerous to surface navigation.",2),
				new listedValue("Distributed Remains of Wreck", "A substantively decayed wreck over which it is safe to navigate but which should be avoided for anchoring, taking the ground or ground fishing.",3),
	...
	/// <summary>
	/// Classification of the zone of confidence in data within an area based on the positional accuracy, survey equipment and coverage.
	/// </summary>
	public class categoryOfZoneOfConfidenceInData : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfZoneOfConfidenceInData";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Zone of Confidence A2", "Positional Accuracy +/- 20 metres; Depth Accuracy 1.0 metre + 2% depth; Full area search undertaken. Significant seafloor features detected and depths measured; Controlled, systematic survey achieving position and depth accuracy less than ZOC A1 and using a modern survey echosounder and a sonar or mechanical sweep system.",2),
				new listedValue("Zone of Confidence B", "Positional Accuracy +/- 50 metres; Depth Accuracy 1.0 metre + 2% depth; Full area search not achieved, uncharted features hazardous to surface navigation are not expected but may exist; Controlled, systematic survey achieving similar depth but lesser position accuracies than ZOCA2, using a modern survey echosounder, but no sonar or mechanical sweep system.",3),
				new listedValue("Zone of Confidence C", "Positional Accuracy +/- 500 metres; Depth Accuracy 2.0 metre + 5% depth; Full area search not achieved, depth anomalies may be expected; Low accuracy survey or data collected on an opportunity basis such as soundings on passage.",4),
	...
	/// </summary>
	public class colour : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "colour";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("White", "",1),
				new listedValue("Black", "",2),
				new listedValue("Red", "",3),
				new listedValue("Green", "",4),
				new listedValue("Blue", "",5),
				new listedValue("Yellow", "",6),
				new listedValue("Grey", "",7),
				new listedValue("Brown", "",8),
				new listedValue("Amber", "",9),
				new listedValue("Violet", "",10),
				new listedValue("Orange", "",11),
	...
	/// </summary>
	public class colourPattern : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "colourPattern";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class communicationChannel : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "communicationChannel";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class condition : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "condition";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class contactInstructions : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "contactInstructions";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class dataAssessment : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "dataAssessment";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class dateDisused : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "dateDisused";
		[JsonIgnore]
	...
	/// </summary>
	public class dateEnd : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "dateEnd";
		[JsonIgnore]
		public override string valueType => "S100_TruncatedDate";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class dateFixed : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "dateFixed";
		[JsonIgnore]
		public override string valueType => "S100_TruncatedDate";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class dateStart : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "dateStart";
		[JsonIgnore]
		public override string valueType => "S100_TruncatedDate";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class dateVariable : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "dateVariable";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class dayOfWeek : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "dayOfWeek";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class dayOfWeekIsRange : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "dayOfWeekIsRange";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class defaultClearanceDepth : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "defaultClearanceDepth";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class depthRangeMaximumValue : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "depthRangeMaximumValue";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class depthRangeMinimumValue : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "depthRangeMinimumValue";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class destination : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "destination";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// <summary>
	/// A statement indicating whether a distance mark is visible or not.
	/// </summary>
	public class distanceMarkVisible : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "distanceMarkVisible";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class distanceUnitOfMeasurement : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "distanceUnitOfMeasurement";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Metres", "The basic unit of length in the International System of Units (SI) system.",1),
				new listedValue("Yards", "A common unit of linear measure in English-speaking countries, equal to 3 feet or 36 inches, and equivalent to 0.9144 metre.",2),
				new listedValue("Kilometres", "A unit of length, the common measure of distances equal to 1000 metres, and equivalent to 3280.8 feet or 0.621 mile.",3),
	...
	/// </summary>
	public class dredgedDate : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "dredgedDate";
		[JsonIgnore]
		public override string valueType => "S100_TruncatedDate";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class elevation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "elevation";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class estimatedRangeOfTransmission : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "estimatedRangeOfTransmission";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class exhibitionConditionOfLight : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "exhibitionConditionOfLight";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class expositionOfSounding : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "expositionOfSounding";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class fileLocator : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "fileLocator";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class fileReference : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "fileReference";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class flareBearing : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "flareBearing";
		[JsonIgnore]
	...
	/// </summary>
	public class flareStack : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "flareStack";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class frequencyShoreStationReceives : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "frequencyShoreStationReceives";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class frequencyShoreStationTransmits : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "frequencyShoreStationTransmits";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// A numeric value used to indicate that datasets are intended to form a seamless presentation.
	/// </summary>
	public class drawingIndex : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "drawingIndex";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class fullSeafloorCoverageAchieved : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "fullSeafloorCoverageAchieved";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class function : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "function";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class headline : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "headline";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class height : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "height";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The length of a feature, such as a lock or basin, which is available for safe navigation. This may, or may not, be the same as the total physical length of the feature.
	/// </summary>
	public class horizontalClearanceLength : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "horizontalClearanceLength";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The physical horizontal clearance distance between two points on a feature, such as a bridge span, dock, gate, lock or tunnel.
	/// </summary>
	public class horizontalClearanceValue : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "horizontalClearanceValue";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The width of a feature, such as a lock or basin, which is available for safe navigation. This may, or may not, be the same as the total physical width of the feature.
	/// </summary>
	public class horizontalClearanceWidth : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "horizontalClearanceWidth";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class horizontalDistanceUncertainty : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "horizontalDistanceUncertainty";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class horizontalLength : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "horizontalLength";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class horizontalWidth : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "horizontalWidth";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class iceFactor : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "iceFactor";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// A defined maritime traffic route that has been adopted as an IMO routeing measure.
	/// </summary>
	public class iMOAdopted : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "iMOAdopted";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// <summary>
	/// A statement that expresses if an area is in a jurisdictional dispute.
	/// </summary>
	public class inDispute : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "inDispute";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class interoperabilityIdentifier : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "interoperabilityIdentifier";
		[JsonIgnore]
	...
	/// </summary>
	public class inTheWater : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "inTheWater";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class isMRCC : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "isMRCC";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class jurisdiction : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "jurisdiction";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class language : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "language";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class leastDepthOfDetectedFeaturesMeasured : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "leastDepthOfDetectedFeaturesMeasured";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The specific safe lifting capacity of a feature.
	/// </summary>
	public class liftingCapacity : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "liftingCapacity";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class lightCharacteristic : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "lightCharacteristic";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class lightVisibility : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "lightVisibility";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class lineSpacingMaximum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "lineSpacingMaximum";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class lineSpacingMinimum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "lineSpacingMinimum";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class linkage : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "linkage";
		[JsonIgnore]
	...
	/// </summary>
	public class magneticAnomalyValue : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "magneticAnomalyValue";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class referenceDirection : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "referenceDirection";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class majorLight : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "majorLight";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class marksNavigationalSystemOf : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "marksNavigationalSystemOf";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class maximumDisplayScale : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "maximumDisplayScale";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class maximumPermittedDraught : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "maximumPermittedDraught";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class maximumPermittedVesselLength : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "maximumPermittedVesselLength";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// A course at sea, whose ends are indicated by ranges ashore, and whose length has been accurately measured for determining the speed of vessels.
	/// </summary>
	public class measuredDistance : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "measuredDistance";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The maximum spacing of the principal measurement lines of a hydrographic survey.
	/// </summary>
	public class measurementDistanceMaximum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "measurementDistanceMaximum";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The minimum spacing of the principal measurement lines of a hydrographic survey.
	/// </summary>
	public class measurementDistanceMinimum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "measurementDistanceMinimum";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class minimumDisplayScale : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "minimumDisplayScale";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class mMSICode : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "mMSICode";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class moireEffect : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "moireEffect";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class multiplicityKnown : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "multiplicityKnown";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class name : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "name";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class nameOfResource : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "nameOfResource";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class nameUsage : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "nameUsage";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class nationality : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "nationality";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class natureOfConstruction : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "natureOfConstruction";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class natureOfSurface : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "natureOfSurface";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Mud", "Soft, wet earth.",1),
				new listedValue("Clay", "(Particles of less than 0.002mm); stiff, sticky earth that becomes hard when baked.",2),
				new listedValue("Silt", "An unconsolidated sediment whose particles range in size from 0.0039 to 0.0625 millimetres in diameter (between clay and sand size).",3),
				new listedValue("Sand", "Loose material consisting of small but easily distinguishable, separate grains, between 0.0625 and 2.000 millimetres in diameter.",4),
				new listedValue("Stone", "A general term for rock and rock fragments ranging in size from pebbles and gravel to boulders or large rock masses.",5),
				new listedValue("Gravel", "(Particles of 2.0 - 4.0mm); small stones with coarse sand.",6),
				new listedValue("Pebbles", "A small stone worn smooth and rounded by the action of water, sand, ice, etc. ranging in diameter between 4 and 64 millimetres.",7),
				new listedValue("Cobbles", "A naturally rounded stone larger than a pebble.",8),
				new listedValue("Rock", "Any formation of natural origin that constitutes an integral part of the lithosphere. The natural occurring material that forms firm, hard, and solid masses.",9),
				new listedValue("Lava", "The fluid or semi-fluid matter flowing from a volcano. The substance that results from the cooling of the molten rock. Part of the ocean bed is composed of lava.",11),
				new listedValue("Coral", "Hard calcareous skeletons of many tribes of marine polyps.",14),
	...
	/// </summary>
	public class natureOfSurfaceQualifyingTerms : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "natureOfSurfaceQualifyingTerms";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Fine", "Falls within the smallest size continuum for a particular nature of surface term.",1),
				new listedValue("Medium", "Falls within the moderate size continuum for a particular nature of surface term.",2),
				new listedValue("Coarse", "Falls within the largest size continuum for a particular nature of surface term.",3),
				new listedValue("Broken", "Fractured or in pieces.",4),
				new listedValue("Sticky", "Having an adhesive or glue like property.",5),
				new listedValue("Soft", "Not hard or firm.",6),
				new listedValue("Stiff", "Not pliant; thick, resistant to flow.",7),
				new listedValue("Volcanic", "Composed of or containing material ejected from a volcano.",8),
	...
	/// </summary>
	public class numberOfFeatures : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "numberOfFeatures";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// A bridge that is closed when set for carrying road traffic and open when set to permit marine traffic to pass through the waterway it crosses. Modern opening (movable) bridges are either bascule, vertical lift or swing.
	/// </summary>
	public class openingBridge : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "openingBridge";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class orientationUncertainty : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "orientationUncertainty";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class orientationValue : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "orientationValue";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class pictorialRepresentation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "pictorialRepresentation";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class pilotMovement : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "pilotMovement";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class product : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		...
		public override listedValue[] listedValues => [
				...
				new listedValue("Water", "A colourless, odourless, tasteless liquid that is a compound of hydrogen and oxygen.",3),
				...
				new listedValue("Drinking Water", "Water that is suitable for human consumption.",8),
				...
				new listedValue("Electricity", "Electric charge or current.",23),
	...
	/// </summary>
	public class qualityOfHorizontalMeasurement : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "qualityOfHorizontalMeasurement";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class qualityOfVerticalMeasurement : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "qualityOfVerticalMeasurement";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class radarBand : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "radarBand";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class radarConspicuous : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "radarConspicuous";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class radius : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "radius";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class referenceLocation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "referenceLocation";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The reference tide to which the series of tidal stream values apply.
	/// </summary>
	public class referenceTide : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "referenceTide";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// The type of tide range (that is, mean spring tide, mean neap tide or mean tide) for which a set of tidal stream rates and directions apply.
	/// </summary>
	public class referenceTideType : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "referenceTideType";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class referenceYearForMagneticVariation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "referenceYearForMagneticVariation";
		[JsonIgnore]
		public override string valueType => "S100_TruncatedDate";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class regulationCitation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "regulationCitation";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class reportedDate : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "reportedDate";
		[JsonIgnore]
		public override string valueType => "S100_TruncatedDate";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class restriction : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "restriction";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Drilling Prohibited", "An area within which excavating a hole on the seabed with a drill is prohibited.",20),
				new listedValue("Drilling Restricted", "A specified area designated by an appropriate authority, within which excavating a hole on the seabed with a drill is restricted in accordance with certain specified conditions.",21),
				...
				new listedValue("Dragging Prohibited", "An area in which the dragging of anything along the seabed, for example bottom trawling, is prohibited.",24),
	...
	/// </summary>
	public class scaleMinimum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "scaleMinimum";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The largest scale for the range of survey scale.
	/// </summary>
	public class scaleValueMaximum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "scaleValueMaximum";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The smallest scale for the range of survey scale.
	/// </summary>
	public class scaleValueMinimum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "scaleValueMinimum";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class sectorBearing : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "sectorBearing";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class sectorArcExtension : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "sectorArcExtension";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class sectorLineLength : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "sectorLineLength";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class signalDuration : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "signalDuration";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class signalFrequency : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "signalFrequency";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class signalGeneration : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "signalGeneration";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class signalGroup : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "signalGroup";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class signalPeriod : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "signalPeriod";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class signalStatus : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "signalStatus";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class significantFeaturesDetected : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "significantFeaturesDetected";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class sizeOfFeaturesDetected : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "sizeOfFeaturesDetected";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class source : SimpleAttribute
	{
		[JsonIgnore]
	...
	/// <summary>
	/// The maximum allowed rate of travel in an area.
	/// </summary>
	public class speedLimit : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "speedLimit";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// Rate of motion. The terms speed and velocity are often used interchangeably, but speed is a scalar, having magnitude only, while velocity is a vector quantity, having both magnitude and direction. Speed maximum is the maximum rate of travel that can occur.
	/// </summary>
	public class speedMaximum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "speedMaximum";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// Rate of motion. The terms speed and velocity are often used interchangeably, but speed is a scalar, having magnitude only, while velocity is a vector quantity, having both magnitude and direction. Speed minimum is the minimum rate of travel that can occur.
	/// </summary>
	public class speedMinimum : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "speedMinimum";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class speedUnits : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "speedUnits";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class stationName : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "stationName";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class stationNumber : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "stationNumber";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class status : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "status";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// <summary>
	/// The depth below the sea surface to which the tidal stream data refers relative to the sounding datum.
	/// </summary>
	public class streamDepth : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "streamDepth";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The depth value determined for seabed around an underwater hazard, based on the depth of the surrounding area.
	/// </summary>
	public class surroundingDepth : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "surroundingDepth";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class surveyAuthority : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "surveyAuthority";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// <summary>
	/// Classification of the different survey types.
	/// </summary>
	public class surveyType : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "surveyType";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Controlled Survey", "A thorough survey usually conducted with reference to guidelines.",2),
				new listedValue("Examination Survey", "A survey principally aimed at the investigation of underwater obstructions and dangers.",4),
				new listedValue("Passage Survey", "A survey where soundings are acquired by vessels on passage.",5),
				new listedValue("Remotely Sensed", "A survey where features have been positioned and delimited using remote sensing techniques.",6),
				new listedValue("Full Coverage", "A survey achieving 100% coverage using systematic, controlled techniques providing full seafloor coverage or full coverage to a defined depth and an investigation of all contacts.",7),
				new listedValue("Systematic Survey", "A controlled survey but full coverage may not have been achieved.",8),
				new listedValue("Non-Systematic Survey", "A survey of lower quality than a full coverage and systematic survey. Such surveys may be further categorized as reconnaissance, sketch, track, passage, remotely sensed and spot-sounding surveys.",9),
				new listedValue("Inadequately Surveyed", "Not surveyed to modern standards; or due to its age, scale, or positional or vertical uncertainties is not suitable to the type of navigation expected in the area.",10),
				new listedValue("Spot-Sounding Survey", "A survey that uses a regular (for example grid) or irregular pattern of soundings obtained one at a time, and normally with very wide spacing.",11),
	...
	/// </summary>
	public class updateNumber : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "updateNumber";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// An action performed when the contents of a dataset are changed.
	/// </summary>
	public class updateType : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "updateType";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Insert", "To put or introduce into the body of something.",1),
				new listedValue("Delete", "To eliminate especially by removing, cutting out or erasing.",2),
	...
	/// </summary>
	public class sweptDate : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "sweptDate";
		[JsonIgnore]
		public override string valueType => "S100_TruncatedDate";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class techniqueOfVerticalMeasurement : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "techniqueOfVerticalMeasurement";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class telecommunicationIdentifier : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "telecommunicationIdentifier";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class telecommunicationService : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "telecommunicationService";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class text : SimpleAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class textOffsetBearing : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "textOffsetBearing";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class textOffsetDistance : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "textOffsetDistance";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class textRotation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "textRotation";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class textType : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "textType";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class timeOfDayEnd : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "timeOfDayEnd";
		[JsonIgnore]
	...
	/// </summary>
	public class timeOfDayStart : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "timeOfDayStart";
		[JsonIgnore]
		public override string valueType => "time";
		public S100Framework.DomainModel.S100.Time? value { get; set; } = default;
	}
	...
	/// <summary>
	/// The time difference relative to the reference tide.
	/// </summary>
	public class timeRelativeToTide : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "timeRelativeToTide";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class topmarkDaymarkShape : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "topmarkDaymarkShape";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Rectangle (Vertical)", "A vertical rectangle is where the two longer opposite sides are standing vertically.",21),
	...
	/// </summary>
	public class trafficFlow : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "trafficFlow";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class uncertaintyFixed : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "uncertaintyFixed";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class uncertaintyVariableFactor : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "uncertaintyVariableFactor";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class underlyingLayer : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "underlyingLayer";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// </summary>
	public class valueOfAnnualChangeInMagneticVariation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "valueOfAnnualChangeInMagneticVariation";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class valueOfDepthContour : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "valueOfDepthContour";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class valueOfMagneticVariation : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "valueOfMagneticVariation";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class valueOfMaximumRange : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "valueOfMaximumRange";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class valueOfNominalRange : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "valueOfNominalRange";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class valueOfSounding : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "valueOfSounding";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// <summary>
	/// A statement that expresses if the vertical clearance for a feature in the open position, such as a bridge span, is unlimited.
	/// </summary>
	public class verticalClearanceUnlimited : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "verticalClearanceUnlimited";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class verticalClearanceValue : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "verticalClearanceValue";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class verticalDatum : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "verticalDatum";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class verticalLength : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "verticalLength";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class vesselClass : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "vesselClass";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
	...
	/// </summary>
	public class virtualAISAidToNavigationType : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "virtualAISAidToNavigationType";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				...
				new listedValue("Port Lateral (IALA A)", "Indicates the port boundary of a navigational channel or suggested route when proceeding in the “conventional direction of buoyage” in the IALA A system.",5),
				new listedValue("Starboard Lateral (IALA A)", "Indicates the starboard boundary of a navigational channel or suggested route when proceeding in the “conventional direction of buoyage” in the IALA A system.",6),
				new listedValue("Port Lateral (IALA B)", "Indicates the port boundary of a navigational channel or suggested route when proceeding in the “conventional direction of buoyage” in the IALA B system.",7),
				new listedValue("Starboard Lateral (IALA B)", "Indicates the starboard boundary of a navigational channel or suggested route when proceeding in the “conventional direction of buoyage” in the IALA B system.",8),
	...
	/// </summary>
	public class visitorsMooring : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "visitorsMooring";
		[JsonIgnore]
		public override string valueType => "boolean";
		public Boolean? value { get; set; } = default;
	}
	...
	/// </summary>
	public class visualProminence : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "visualProminence";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class waterLevelEffect : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "waterLevelEffect";
		[JsonIgnore]
		public override listedValue[] listedValues => [
				new listedValue("Partly Submerged at High Water", "Partially covered and partially dry at high water.",1),
				new listedValue("Always Dry", "Not covered at high water under average meteorological conditions.",2),
				new listedValue("Always Under Water/Submerged", "Remains covered by water at all times under average meteorological conditions.",3),
				new listedValue("Covers and Uncovers", "Expression intended to indicate an area of a reef or other projection from the bottom of a body of water which periodically extends above and is submerged below the surface. Also referred to as dries or uncovers.",4),
				new listedValue("Awash", "Flush with, or washed by the waves at low water under average meteorological conditions.",5),
	...
	/// <summary>
	/// The length of the space between two points along a waterway.
	/// </summary>
	public class waterwayDistance : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "waterwayDistance";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class waveLengthValue : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "waveLengthValue";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class categoryOfCargo : SimpleEnumerationAttribute
	{
		[JsonIgnore]
		public override string code => "categoryOfCargo";
		[JsonIgnore]
		public override listedValue[] listedValues => [
	...
	/// </summary>
	public class minimumBerthDepth : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "minimumBerthDepth";
		[JsonIgnore]
		public override string valueType => "real";
		public double? value { get; set; } = default;
	}
	...
	/// </summary>
	public class optimumDisplayScale : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "optimumDisplayScale";
		[JsonIgnore]
		public override string valueType => "integer";
		public int? value { get; set; } = default;
	}
	...
	/// <summary>
	/// Text describing one or more graphic elements that must be rendered in an end-user system.
	/// </summary>
	public class drawingInstruction : SimpleAttribute
	{
		[JsonIgnore]
		public override string code => "drawingInstruction";
		[JsonIgnore]
		public override string valueType => "text";
		public String? value { get; set; } = default;
	}
...
namespace S100Framework.DomainModel.S101.ComplexAttributes
{
	...
	/// </summary>
	public class featureName : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class featuresDetected : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class fixedDateRange : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class frequencyPair : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class horizontalClearanceFixed : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class horizontalClearanceOpen : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class horizontalPositionUncertainty : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class information : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class measuredDistanceValue : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// The number of features of identical character that exist as a co-located group.
	/// </summary>
	public class multiplicityOfFeatures : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class onlineResource : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// The angular distance measured from true north to the major axis of the feature.
	/// </summary>
	public class orientation : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class periodicDateRange : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class radarWaveLength : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class sectorInformation : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class sectorLimitOne : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class sectorLimitTwo : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class shapeInformation : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class signalSequence : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class speed : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class surfaceCharacteristics : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class surveyDateRange : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class telecommunications : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class tidalStreamValue : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class timeIntervalsByDayOfWeek : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class topmark : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class valueOfLocalMagneticAnomaly : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class verticalUncertainty : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class vesselSpeedLimit : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class zoneOfConfidence : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class directionalCharacter : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// The sequence of times occupied by intervals of light/sound and eclipse/silence for all light characteristics or sound signals.
	/// </summary>
	public class rhythmOfLight : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class scheduleByDayOfWeek : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class sectorLimit : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class spatialAccuracy : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class tidalStreamPanelValues : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class verticalClearanceClosed : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class verticalClearanceFixed : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class verticalClearanceOpen : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class verticalClearanceSafe : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class lightSector : ComplexAttribute
	{
		[JsonIgnore]
	...
	/// </summary>
	public class sectorCharacteristics : ComplexAttribute
	{
		[JsonIgnore]
...
namespace S100Framework.DomainModel.S101.FeatureTypes
{
	using S100Framework.DomainModel.S101.SimpleAttributes;
	...
	/// </summary>
	public class QualityOfNonBathymetricData : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DataCoverage : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class NavigationalSystemOfMarks : FeatureType
	{
		[JsonIgnore]
	...
	/// An area within which the navigational system of marks has been established in relation to a specific direction.
	/// </summary>
	public class LocalDirectionOfBuoyage : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class QualityOfBathymetricData : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SoundingDatum : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class VerticalDatumOfData : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class QualityOfSurvey : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class UpdateInformation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class MagneticVariation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LocalMagneticAnomaly : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Coastline : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LandArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class IslandGroup : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LandElevation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class River : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Rapids : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Waterfall : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LandRegion : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Vegetation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class IceArea : FeatureType
	{
		[JsonIgnore]
	...
	/// An inclined surface.
	/// </summary>
	public class SlopingGround : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SlopeTopline : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Tideway : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class BuiltUpArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Building : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class AirportAirfield : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Runway : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Helipad : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Bridge : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SpanFixed : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SpanOpening : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Conveyor : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CableOverhead : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class PipelineOverhead : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class PylonBridgeSupport : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FenceWall : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Railway : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Tunnel : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Landmark : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SiloTank : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class WindTurbine : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FortifiedStructure : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ProductionStorageArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Checkpoint : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ShorelineConstruction : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class StructureOverNavigableWater : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Causeway : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Canal : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DistanceMark : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Crane : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Berth : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Dolphin : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Bollard : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DryDock : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FloatingDock : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Pontoon : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DockArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Gridiron : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LockBasin : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class MooringTrot : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SeaAreaNamedWaterArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TidalStreamFloodEbb : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CurrentNonGravitational : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class WaterTurbulence : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TidalStreamPanelData : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Sounding : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DredgedArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SweptArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DepthContour : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DepthArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DepthNoBottomFound : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class UnsurveyedArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SeabedArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class WeedKelp : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Seagrass : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Sandwave : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Spring : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class UnderwaterAwashRock : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Wreck : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Obstruction : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FoulGround : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DiscolouredWater : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FishingFacility : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class MarineFarmCulture : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class OffshorePlatform : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CableSubmarine : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CableArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class PipelineSubmarineOnLand : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SubmarinePipelineArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class OffshoreProductionArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class NavigationLine : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RecommendedTrack : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RangeSystem : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Fairway : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FairwaySystem : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RecommendedRouteCentreline : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TwoWayRoutePart : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TwoWayRoute : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RecommendedTrafficLanePart : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DeepWaterRouteCentreline : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DeepWaterRoutePart : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DeepWaterRoute : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class InshoreTrafficZone : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class PrecautionaryArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TrafficSeparationSchemeLanePart : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SeparationZoneOrLine : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TrafficSeparationSchemeBoundary : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TrafficSeparationSchemeCrossing : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TrafficSeparationSchemeRoundabout : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TrafficSeparationScheme : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ArchipelagicSeaLaneArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ArchipelagicSeaLaneAxis : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ArchipelagicSeaLane : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FerryRoute : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RadarLine : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RadarStation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class AnchorageArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class MooringArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class AnchorBerth : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SeaplaneLandingArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class DumpingGround : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class MilitaryPracticeArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class AdministrationArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CargoTranshipmentArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ContiguousZone : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ContinentalShelfArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CustomZone : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class ExclusiveEconomicZone : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FisheryZone : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FishingGround : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FreePortArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class HarbourAreaAdministrative : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LogPond : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class OilBarrier : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class StraightTerritorialSeaBaseline : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TerritorialSeaArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SubmarineTransitLane : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CollisionRegulationsLimit : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class MarinePollutionRegulationsArea : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LightAllAround : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LightSectored : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LightFogDetector : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LightAirObstruction : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LateralBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CardinalBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class IsolatedDangerBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SafeWaterBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SpecialPurposeGeneralBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class EmergencyWreckMarkingBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class InstallationBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class MooringBuoy : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LateralBeacon : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CardinalBeacon : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class IsolatedDangerBeacon : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SafeWaterBeacon : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SpecialPurposeGeneralBeacon : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Daymark : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LightFloat : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class LightVessel : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Retroreflector : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RadarReflector : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class FogSignal : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class PhysicalAISAidToNavigation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class VirtualAISAidToNavigation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RadarTransponderBeacon : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class PilotBoardingPlace : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class CoastGuardStation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SignalStationTraffic : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class RescueStation : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class HarbourFacility : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class SmallCraftFacility : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class TextPlacement : FeatureType
	{
		[JsonIgnore]
	...
	/// </summary>
	public class Chart1Feature : FeatureType
	{
		[JsonIgnore]
		...
		public static JsonSerializerOptions AppendTypeInfoResolver(this JsonSerializerOptions jsonSerializerOptions) {
			...
			resolver.Modifiers.Add(typeInfo => {
				if (typeInfo.Type == typeof(S100Framework.DomainModel.Attribute)) {
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(bridgeConstruction), typeDiscriminator: "bridgeConstruction"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(bridgeFunction), typeDiscriminator: "bridgeFunction"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(buriedDepth), typeDiscriminator: "buriedDepth"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfAirportAirfield), typeDiscriminator: "categoryOfAirportAirfield"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfBuiltUpArea), typeDiscriminator: "categoryOfBuiltUpArea"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfCable), typeDiscriminator: "categoryOfCable"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfCanal), typeDiscriminator: "categoryOfCanal"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfCheckpoint), typeDiscriminator: "categoryOfCheckpoint"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfCoastline), typeDiscriminator: "categoryOfCoastline"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfConveyor), typeDiscriminator: "categoryOfConveyor"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfCrane), typeDiscriminator: "categoryOfCrane"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfDam), typeDiscriminator: "categoryOfDam"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfDock), typeDiscriminator: "categoryOfDock"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfDumpingGround), typeDiscriminator: "categoryOfDumpingGround"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfFence), typeDiscriminator: "categoryOfFence"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfFerry), typeDiscriminator: "categoryOfFerry"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfFishingFacility), typeDiscriminator: "categoryOfFishingFacility"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfFortifiedStructure), typeDiscriminator: "categoryOfFortifiedStructure"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfGate), typeDiscriminator: "categoryOfGate"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfHulk), typeDiscriminator: "categoryOfHulk"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfIce), typeDiscriminator: "categoryOfIce"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfLandRegion), typeDiscriminator: "categoryOfLandRegion"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfMarineFarmCulture), typeDiscriminator: "categoryOfMarineFarmCulture"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfMooringArea), typeDiscriminator: "categoryOfMooringArea"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfObstruction), typeDiscriminator: "categoryOfObstruction"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfOffshoreProductionArea), typeDiscriminator: "categoryOfOffshoreProductionArea"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfOilBarrier), typeDiscriminator: "categoryOfOilBarrier"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfOpeningBridge), typeDiscriminator: "categoryOfOpeningBridge"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfPipelinePipe), typeDiscriminator: "categoryOfPipelinePipe"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfProductionArea), typeDiscriminator: "categoryOfProductionArea"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfPylon), typeDiscriminator: "categoryOfPylon"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfRadarStation), typeDiscriminator: "categoryOfRadarStation"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfRescueStation), typeDiscriminator: "categoryOfRescueStation"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfRoad), typeDiscriminator: "categoryOfRoad"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfSeaArea), typeDiscriminator: "categoryOfSeaArea"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfShorelineConstruction), typeDiscriminator: "categoryOfShorelineConstruction"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfSlope), typeDiscriminator: "categoryOfSlope"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfSmallCraftFacility), typeDiscriminator: "categoryOfSmallCraftFacility"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfStructure), typeDiscriminator: "categoryOfStructure"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfTidalStream), typeDiscriminator: "categoryOfTidalStream"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfVegetation), typeDiscriminator: "categoryOfVegetation"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfWaterTurbulence), typeDiscriminator: "categoryOfWaterTurbulence"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfWeedKelp), typeDiscriminator: "categoryOfWeedKelp"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfWreck), typeDiscriminator: "categoryOfWreck"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(categoryOfZoneOfConfidenceInData), typeDiscriminator: "categoryOfZoneOfConfidenceInData"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(dataAssessment), typeDiscriminator: "dataAssessment"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(dateDisused), typeDiscriminator: "dateDisused"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(defaultClearanceDepth), typeDiscriminator: "defaultClearanceDepth"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(depthRangeMaximumValue), typeDiscriminator: "depthRangeMaximumValue"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(distanceMarkVisible), typeDiscriminator: "distanceMarkVisible"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(distanceUnitOfMeasurement), typeDiscriminator: "distanceUnitOfMeasurement"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(dredgedDate), typeDiscriminator: "dredgedDate"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(expositionOfSounding), typeDiscriminator: "expositionOfSounding"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(flareStack), typeDiscriminator: "flareStack"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(drawingIndex), typeDiscriminator: "drawingIndex"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(fullSeafloorCoverageAchieved), typeDiscriminator: "fullSeafloorCoverageAchieved"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(horizontalClearanceLength), typeDiscriminator: "horizontalClearanceLength"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(horizontalClearanceValue), typeDiscriminator: "horizontalClearanceValue"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(horizontalClearanceWidth), typeDiscriminator: "horizontalClearanceWidth"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(horizontalLength), typeDiscriminator: "horizontalLength"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(horizontalWidth), typeDiscriminator: "horizontalWidth"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(iceFactor), typeDiscriminator: "iceFactor"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(iMOAdopted), typeDiscriminator: "iMOAdopted"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(inDispute), typeDiscriminator: "inDispute"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(inTheWater), typeDiscriminator: "inTheWater"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(leastDepthOfDetectedFeaturesMeasured), typeDiscriminator: "leastDepthOfDetectedFeaturesMeasured"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(liftingCapacity), typeDiscriminator: "liftingCapacity"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(lineSpacingMaximum), typeDiscriminator: "lineSpacingMaximum"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(lineSpacingMinimum), typeDiscriminator: "lineSpacingMinimum"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(magneticAnomalyValue), typeDiscriminator: "magneticAnomalyValue"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(referenceDirection), typeDiscriminator: "referenceDirection"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(measuredDistance), typeDiscriminator: "measuredDistance"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(measurementDistanceMaximum), typeDiscriminator: "measurementDistanceMaximum"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(measurementDistanceMinimum), typeDiscriminator: "measurementDistanceMinimum"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(natureOfSurface), typeDiscriminator: "natureOfSurface"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(natureOfSurfaceQualifyingTerms), typeDiscriminator: "natureOfSurfaceQualifyingTerms"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(openingBridge), typeDiscriminator: "openingBridge"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(referenceLocation), typeDiscriminator: "referenceLocation"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(referenceTide), typeDiscriminator: "referenceTide"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(referenceTideType), typeDiscriminator: "referenceTideType"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(referenceYearForMagneticVariation), typeDiscriminator: "referenceYearForMagneticVariation"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(regulationCitation), typeDiscriminator: "regulationCitation"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(scaleValueMaximum), typeDiscriminator: "scaleValueMaximum"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(scaleValueMinimum), typeDiscriminator: "scaleValueMinimum"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(signalFrequency), typeDiscriminator: "signalFrequency"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(significantFeaturesDetected), typeDiscriminator: "significantFeaturesDetected"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(sizeOfFeaturesDetected), typeDiscriminator: "sizeOfFeaturesDetected"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(speedLimit), typeDiscriminator: "speedLimit"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(speedMaximum), typeDiscriminator: "speedMaximum"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(speedMinimum), typeDiscriminator: "speedMinimum"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(speedUnits), typeDiscriminator: "speedUnits"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(stationName), typeDiscriminator: "stationName"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(stationNumber), typeDiscriminator: "stationNumber"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(streamDepth), typeDiscriminator: "streamDepth"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(surroundingDepth), typeDiscriminator: "surroundingDepth"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(surveyAuthority), typeDiscriminator: "surveyAuthority"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(surveyType), typeDiscriminator: "surveyType"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(updateType), typeDiscriminator: "updateType"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(sweptDate), typeDiscriminator: "sweptDate"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(timeRelativeToTide), typeDiscriminator: "timeRelativeToTide"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(underlyingLayer), typeDiscriminator: "underlyingLayer"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(valueOfAnnualChangeInMagneticVariation), typeDiscriminator: "valueOfAnnualChangeInMagneticVariation"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(valueOfDepthContour), typeDiscriminator: "valueOfDepthContour"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(valueOfMagneticVariation), typeDiscriminator: "valueOfMagneticVariation"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(valueOfMaximumRange), typeDiscriminator: "valueOfMaximumRange"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(valueOfSounding), typeDiscriminator: "valueOfSounding"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(verticalClearanceUnlimited), typeDiscriminator: "verticalClearanceUnlimited"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(vesselClass), typeDiscriminator: "vesselClass"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(waterLevelEffect), typeDiscriminator: "waterLevelEffect"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(waterwayDistance), typeDiscriminator: "waterwayDistance"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(drawingInstruction), typeDiscriminator: "drawingInstruction"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(featuresDetected), typeDiscriminator: "featuresDetected"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(horizontalClearanceFixed), typeDiscriminator: "horizontalClearanceFixed"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(horizontalClearanceOpen), typeDiscriminator: "horizontalClearanceOpen"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(measuredDistanceValue), typeDiscriminator: "measuredDistanceValue"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(shapeInformation), typeDiscriminator: "shapeInformation"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(speed), typeDiscriminator: "speed"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(surfaceCharacteristics), typeDiscriminator: "surfaceCharacteristics"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(tidalStreamValue), typeDiscriminator: "tidalStreamValue"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(topmark), typeDiscriminator: "topmark"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(valueOfLocalMagneticAnomaly), typeDiscriminator: "valueOfLocalMagneticAnomaly"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(vesselSpeedLimit), typeDiscriminator: "vesselSpeedLimit"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(zoneOfConfidence), typeDiscriminator: "zoneOfConfidence"));
					...
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(tidalStreamPanelValues), typeDiscriminator: "tidalStreamPanelValues"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(verticalClearanceClosed), typeDiscriminator: "verticalClearanceClosed"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(verticalClearanceFixed), typeDiscriminator: "verticalClearanceFixed"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(verticalClearanceOpen), typeDiscriminator: "verticalClearanceOpen"));
					typeInfo.PolymorphismOptions.DerivedTypes.Add(new System.Text.Json.Serialization.Metadata.JsonDerivedType(typeof(verticalClearanceSafe), typeDiscriminator: "verticalClearanceSafe"));
