        ...
        static Logger() {
            _logger = new LoggerConfiguration()
                ...
                .WriteTo.Logger(lc => lc
                    ...
                    .WriteTo.Console()
                    .WriteTo.File(System.IO.Path.Combine(_logDir, @"Vortex", "ROSLYN", $"{_dateTimeString}", "ROSLYN_System.log"),
                ...
                .WriteTo.Logger(lc => lc
                    .MinimumLevel.Error()
                    .WriteTo.File(System.IO.Path.Combine(_logDir, @"Vortex", "ROSLYN", $"{_dateTimeString}", $"ROSLYN_Error.log"),
                    rollingInterval: RollingInterval.Infinite,
                    shared: true,
                    encoding: System.Text.Encoding.GetEncoding("ISO-8859-1"),
